...
#include "../../../../../../src/core/include/SessionController.h"
...
template <> constexpr inline auto SessionController::qt_create_metaobjectdata<qt_meta_tag_ZN17SessionControllerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QPixmap &, const QPixmap &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { 0x80000000 | 3, 5 },
        }}),
        // Signal 'detectionsUpdated'
        QtMocHelpers::SignalData<void(const QVector<QRect> &)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
    };
...
void SessionController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->imagesUpdated((*reinterpret_cast<std::add_pointer_t<QPixmap>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QPixmap>>(_a[2]))); break;
        case 1: _t->detectionsUpdated((*reinterpret_cast<std::add_pointer_t<QList<QRect>>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SessionController::*)(const QPixmap & , const QPixmap & )>(_a, &SessionController::imagesUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SessionController::*)(const QVector<QRect> & )>(_a, &SessionController::detectionsUpdated, 1))
            return;
    }
}
...
// SIGNAL 0
void SessionController::imagesUpdated(const QPixmap & _t1, const QPixmap & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void SessionController::detectionsUpdated(const QVector<QRect> & _t1)
{
